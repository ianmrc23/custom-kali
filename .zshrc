...
alias cat='/usr/bin/batcat --paging=never --plain'
alias catn='/usr/bin/batcat'
...
source /home/s3rp3nt/.powerlevel10k/powerlevel10k.zsh-theme
...
# Mostrar el nombre del entorno virtual activo en el prompt
virtualenv_info() {
  [[ -n "$VIRTUAL_ENV" ]] && echo "(${VIRTUAL_ENV:t})"
}

# Actualiza el prompt con el nombre del entorno virtual activo
precmd() {
  PS1="%{$fg_bold[cyan]%}$(virtualenv_info)%{$reset_color%}${NEWLINE}% ${_OLD_VIRTUAL_PS1}"
}
